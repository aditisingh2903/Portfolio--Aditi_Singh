// Resume-derived fallback content. Used by PortfolioContext when the backend
// is unreachable or not seeded, so the site always renders with real content.
// Mirrors the shape of the seed in backend/seed/index.js.
...
export const defaultProfile = {
  ...
  summary:
    'CSE Undergrad with strong knowledge of React, Django, JavaScript, IoT systems, and teamwork. Built award-winning Smart Waste Management System (BinSense) and contributed to AI-driven projects like Tiger Detection using YOLOv8. Skilled in Canva design, PPT making, and communication.',
  socials: [
...
export const defaultProjects = [
  {
    ...
    description:
      'IoT sensor network streaming real-time dustbin fill-level telemetry to Firebase with automated municipal alerts.',
    longDescription: [
  ...
  },
  {
    ...
    description:
      'Edge-deployed ISL-to-English translation system using MediaPipe and TensorFlow with 99.89% accuracy.',
    longDescription: [
  ...
  },
  {
    ...
    description:
      'AI-based Medical Report Summarizer with OCR + Groq LLM for condition detection and diet recommendations.',
    longDescription: [
  ...
  },
  {
    ...
    description:
      'Real-time AI-powered system to detect tigers from live camera feeds with remote alerts for forest officials.',
    longDescription: [
...
export const defaultExperience = [
  {
    _id: 'e1',
    role: 'Hackathon Winner - Smart India Hackathon 2025',
    organization: 'Government of India (PSID 25247)',
    startDate: '2025',
    endDate: '2025',
    type: 'hackathon',
    description: [
      'Developed SHRUTI-AI, a real-time sign language recognition and communication system using computer vision and full-stack web technologies to bridge communication gaps.',
    ],
    order: 0,
    published: true,
  },
...
export const defaultEducation = [
  {
    ...
    score: '8.34',
    scoreType: 'CPI',
    description: ['CPI: 8.34'],
    order: 0,
    published: true,
  },
  {
    _id: 'ed2',
    institution: 'Holy Cross Higher Secondary School, Bayron Bazar, Raipur',
    degree: 'Higher Secondary',
    field: 'PCM + Informatic Practices',
    startDate: '',
    endDate: 'Jul 2022',
    score: '81%',
...
export const defaultAchievements = [
  {
    _id: 'a1',
    title: 'SIH Winner 2025 (PS ID - 25247)',
    issuer: 'Smart India Hackathon - Hardware Edition',
    date: '2025',
    description:
      'Developed SHRUTI-AI, a real-time sign language recognition and communication system using computer vision and full-stack web technologies to bridge communication gaps.',
    rank: 'Winner',
  ...
  {
    _id: 'a2',
    title: '1st Place - Code of Phoenix Hackathon',
    issuer: 'E-Cell IIIT Naya Raipur',
    date: '2024',
    description: 'BinSense smart waste management system.',
    rank: '1st',
    order: 1,
    published: true,
  },
  {
    _id: 'a3',
    title: '1st Place - Business Plan Pitching Competition',
    issuer: 'Innovation Club, IIC & Dept. of CSE, BIT Durg',
    date: '',
    description: '',
    rank: '1st',
    order: 2,
  ...
  {
    _id: 'a4',
    title: '4th Position - Hack-BIOS',
    issuer: 'Shri Shankaracharya Technical Campus, Durg',
    date: '2025',
    description:
      'Developed AksharDhara, an AI powered translation model for local dialects to natural languages.',
    rank: '4th',
    order: 3,
    published: true,
  },
  {
    _id: 'a5',
    title: '1st Prize - Tech X Survival',
    issuer: 'IEEE Student Branch BIT Durg - Women in Engineering (WIE)',
    date: '',
    description: 'Idea pitching competition.',
    rank: '1st',
    order: 4,
    published: true,
  },
...
export const defaultSeo = {
  ...
  description:
    'Portfolio of Aditi Singh - CSE undergrad, React/Node.js full-stack developer, IoT & AI builder. SIH 2025 Winner, 1st Place Code of the Phoenix Hackathon.',
  keywords: [
    'Aditi Singh',
    'Portfolio',
  ...
  ogDescription:
    'Award-winning full-stack and AI/IoT developer. Explore projects, achievements and experience.',
